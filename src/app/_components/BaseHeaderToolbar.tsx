      ...
      <div className="border-b border-neutral-200 bg-white">
        ...
        <div className="grid h-14 grid-cols-[1fr_auto_1fr] items-center px-4">
          ...
          <nav className="flex items-center justify-center gap-6">
            <button className="relative cursor-pointer text-[13px] font-medium text-neutral-900">
              Data
              <div className="absolute bottom-[-18px] left-0 h-[2px] w-full bg-amber-600" />
            </button>
            <button className="cursor-pointer text-[13px] text-neutral-500 hover:text-neutral-900">
              Automations
            </button>
            <button className="cursor-pointer text-[13px] text-neutral-500 hover:text-neutral-900">
              Interfaces
          ...
          <div className="flex items-center justify-end gap-5">
            ...
            <button
              type="button"
              className="flex h-[32px] cursor-pointer items-center rounded-full bg-neutral-100 px-4 text-[14px] font-medium text-neutral-800"
            >
              Trial: 3 days left
            </button>
            ...
            <div className="flex items-center gap-1.5">
              {/* Launch */}
              <button className="flex h-[28px] w-[80px] cursor-pointer items-center justify-center gap-1.5 rounded border border-neutral-300 text-[13px] text-neutral-800 hover:bg-neutral-50">
                <svg
              ...
              {/* Share */}
              <button className="flex h-[28px] w-[58px] cursor-pointer items-center justify-center rounded bg-amber-600 text-[13px] font-medium text-white hover:bg-amber-700">
                Share
              </button>
            </div>
          </div>
        ...
        <div className="flex h-9 items-center justify-between pr-4">
          ...
          <div className="flex items-center overflow-x-auto py-1 text-[13px]">
              ...
              return (
                <div key={t.id} className="flex items-center">
                  <button
                    ...
                    title={t.name ?? "Table"}
                    className={[
                      "flex items-center px-2 py-[8px] border border-transparent rounded-t-md rounded-b-none transition-colors cursor-pointer",
                      active
                        ? "-mb-px z-10 bg-white text-neutral-900 font-medium border-neutral-300 border-b-transparent shadow-none tab-inset-br"
                        : "text-neutral-700 hover:text-neutral-900 hover:bg-white/40",
                      index === 0 ? "ml-0" : "ml-0.5",
                    ].join(" ")}
                  >
            ...
            <button
              ...
              className="ml-1 flex items-center gap-1 rounded px-2 py-[3px] text-neutral-700 hover:text-neutral-900 disabled:opacity-60 cursor-pointer"
          ...
          <div className="flex items-center gap-1">
            <button
              type="button"
              className="flex items-center gap-[4px] rounded px-2 py-1 text-[13px] text-neutral-600 hover:text-neutral-900 cursor-pointer"
            >
              <span>Tools</span>
              <svg
                width="12"
